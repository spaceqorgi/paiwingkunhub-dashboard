    ...
    <div class="vx-card p-6">
      <div class="flex flex-wrap items-center">
        ...
        <div class="flex-grow">
         ...
         <vs-select  class="w-full mt-4" v-model="fullname" >
          ...
          if (this.amount !== '0') {
            if (this.amount > '0') {
              if (this.selectedFile.size > 0) {
                await axios.post('/agent/addcreditscbonly', {
                ...
                if (this.agent_error.status === true) {
                  await log.agent(this.username, 'Add_credit', this.amount, 'Add_credit Bank-Scb-Only')
                  setTimeout(() => {
